...
A more detailed schedule can be found [here](https://stemangiola.github.io/ABACBS2020_tidytranscriptomics/index.html#time-outline).  
<br>
...
Easiest way to run this material. Only available during workshop. Thanks to Nectar and ARDC for supplying the resources and helping to set up.
...
If you want to install on your own computer, see instructions [here](https://stemangiola.github.io/ABACBS2020_tidytranscriptomics/index.html#workshop-package-installation). We recommend using the Cloud during the ABACBS workshop and this method if you want to run the material after the workshop.

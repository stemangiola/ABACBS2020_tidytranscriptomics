...
We can select some of the transcripts that look different between methods to investigate further using the [*tidygate*](https://github.com/stemangiola/tidygate) package.

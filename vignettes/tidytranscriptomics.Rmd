...
```{r}
data("pasilla", package = "ABACBS2020tidytranscriptomics")
counts_tt <-
    pasilla %>%
    tidybulk() %>%
...
```{r}
pasilla_de <- 
  ABACBS2020tidytranscriptomics::pasilla %>% 
...
## Supplementary
Some things we don't have time to cover in Part 2 of this workshop can be found in the [Supplementary material](https://stemangiola.github.io/ABACBS2020_tidytranscriptomics/articles/supplementary.html).
